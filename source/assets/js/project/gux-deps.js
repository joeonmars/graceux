...
// Please do not edit.
goog.addDependency('../../../../project/apps/main.js', ['gux.apps.Main'], ['goog.dom', 'goog.dom.query', 'goog.fx.anim', 'goog.userAgent', 'gux.controllers.FullscreenLoader', 'gux.controllers.Header', 'gux.controllers.Intro', 'gux.controllers.MainScroller', 'gux.controllers.PortfolioNavigation', 'gux.controllers.Router']);
...
goog.addDependency('../../../../project/controllers/fullscreenloader.js', ['gux.controllers.FullscreenLoader'], ['goog.events.EventHandler', 'goog.events.EventTarget', 'goog.userAgent', 'gux.fx.Shape', 'gux.templates.Main']);
goog.addDependency('../../../../project/controllers/header.js', ['gux.controllers.Header'], ['goog.dom.classlist', 'gux.controllers.ImageViewer', 'gux.events']);
goog.addDependency('../../../../project/controllers/imageviewer.js', ['gux.controllers.ImageViewer'], ['goog.events.EventHandler', 'goog.events.EventTarget', 'goog.events.MouseWheelHandler', 'goog.fx.Dragger', 'goog.style', 'goog.userAgent', 'gux.events', 'gux.templates.Main']);
...
goog.addDependency('../../../../project/controllers/pages/labspage.js', ['gux.controllers.pages.LabsPage'], ['gux.controllers.pages.Page', 'gux.fx.Shape']);
goog.addDependency('../../../../project/controllers/pages/page.js', ['gux.controllers.pages.Page'], ['goog.async.Throttle', 'goog.dom.classlist', 'goog.events.EventHandler', 'goog.events.EventTarget', 'goog.net.XhrIo', 'gux.controllers.ContactForm', 'gux.controllers.modules.VideoPlayer', 'gux.fx.LazyLoader', 'gux.fx.Sticky']);
goog.addDependency('../../../../project/controllers/pages/projectpage.js', ['gux.controllers.pages.ProjectPage'], ['goog.events.MouseWheelHandler', 'goog.string', 'gux.controllers.ImageViewer', 'gux.controllers.modules.Comparison', 'gux.controllers.modules.Intro', 'gux.controllers.modules.Workflow', 'gux.controllers.pages.Page']);
...
goog.addDependency('../../../../project/fx/lazyloader.js', ['gux.fx.LazyLoader'], ['goog.Disposable', 'goog.dom', 'goog.style']);
goog.addDependency('../../../../project/fx/shape.js', ['gux.fx.Shape'], ['goog.math']);
goog.addDependency('../../../../project/fx/sticky.js', ['gux.fx.Sticky'], ['goog.Disposable', 'goog.dom', 'goog.style']);
