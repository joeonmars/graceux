...
// Please do not edit.
goog.addDependency('../../../../project/apps/main.js', ['gux.apps.Main'], ['goog.dom', 'goog.dom.query', 'goog.fx.anim', 'goog.userAgent', 'gux.controllers.FullscreenLoader', 'gux.controllers.Header', 'gux.controllers.Intro', 'gux.controllers.MainScroller', 'gux.controllers.PortfolioNavigation', 'gux.controllers.Router'], false);
...
goog.addDependency('../../../../project/controllers/fullscreenloader.js', ['gux.controllers.FullscreenLoader'], ['goog.events.EventHandler', 'goog.events.EventTarget', 'goog.userAgent', 'gux.fx.Shape', 'gux.templates.Main'], false);
...
goog.addDependency('../../../../project/controllers/imageviewer.js', ['gux.controllers.ImageViewer'], ['goog.events.EventHandler', 'goog.events.EventTarget', 'goog.events.MouseWheelHandler', 'goog.fx.Dragger', 'goog.style', 'goog.userAgent', 'gux.events', 'gux.templates.Main'], false);
...
goog.addDependency('../../../../project/controllers/pages/page.js', ['gux.controllers.pages.Page'], ['goog.async.Throttle', 'goog.dom.classlist', 'goog.events.EventHandler', 'goog.events.EventTarget', 'goog.net.XhrIo', 'gux.controllers.ContactForm', 'gux.controllers.modules.VideoPlayer', 'gux.fx.LazyLoader', 'gux.fx.Sticky'], false);
goog.addDependency('../../../../project/controllers/pages/projectpage.js', ['gux.controllers.pages.ProjectPage'], ['goog.events.MouseWheelHandler', 'goog.string', 'gux.controllers.ImageViewer', 'gux.controllers.modules.Comparison', 'gux.controllers.modules.Intro', 'gux.controllers.modules.Workflow', 'gux.controllers.pages.Page'], false);
