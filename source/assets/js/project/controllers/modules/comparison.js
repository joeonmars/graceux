...
gux.controllers.modules.Comparison = function( element ) {
	...
	this._topImgContainer = goog.dom.query( '.images-container .image-container', this.el )[ 0 ];
...
gux.controllers.modules.Comparison.prototype.resize = function() {
	...
	this._topImgSize = goog.style.getSize( this._topImgContainer );
...
gux.controllers.modules.Comparison.prototype.update = function() {
	...
	goog.style.setStyle( this._topImgContainer, 'clip', 'rect(0px ' + right + 'px ' + bottom + 'px 0px)' );
	...
	if ( progress < .5 ) {
		...
		goog.dom.classlist.enable( this.el, 'highlight-right', true );
		goog.dom.classlist.enable( this.el, 'highlight-left', false );

	} else if ( progress > .5 ) {

		goog.dom.classlist.enable( this.el, 'highlight-right', false );
		goog.dom.classlist.enable( this.el, 'highlight-left', true );
